...
<div class="col-sm-6 col-md-4 col-lg-3 p-b-35 isotope-item women">
					...
					<div class="block2">
						<div class="block2-pic hov-img0">
							<img src="<?php echo $prodAddress.$proData['productImage']?>" alt="IMG-PRODUCT">
						...
						<?php echo $proData['productName']?>
								...
								<span class="stext-105 cl3">
									PKR <?php echo $proData['productPrice']?>
								</span>
							</div>
...
<?php
	...
	$allQuery = $pdo ->query("select * from products");
	...
	foreach($allrows as $allproduct){
		...
		<div class="col-sm-6 col-md-4 col-lg-3 p-b-35 isotope-item women">
					...
					<div class="block2">
						<div class="block2-pic hov-img0">
							<img src="<?php echo $proAddress.$allproduct['productImage']?>" alt="IMG-PRODUCT">
						...
						<?php echo $allproduct['productName']?>
								...
								<span class="stext-105 cl3">
									PKR <?php echo $allproduct['productPrice']?>
								</span>
							</div>
